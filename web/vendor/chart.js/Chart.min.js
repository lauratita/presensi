...
!(function (t, e) {
  ...
  N._set("global", {
    elements: {
      arc: { backgroundColor: N.global.defaultColor, borderColor: "#fff", borderWidth: 2, borderAlign: "center" },
    },
  });
  var st = K.extend({
      _type: "arc",
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip ||
                ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : H.canvas.lineTo(r, e._view, n), (d = t));
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === n.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = H.clone(N.global.plugins[e])), n.push(t), i.push({ plugin: t, options: a || {} }));
            }
          }),
          (e.descriptors = i),
          (e.id = this._cacheId),
  ...
  var zn = yn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Rn(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(On(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(On(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
      ...
      getPixelForValue: function (t) {
        var e = this,
          n = 0;
        return (
          (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (On(t) - e._startValue) / e._valueRange + e._valueOffset),
  ...
  rn._date.override(
    "function" == typeof t
      ? {
          ...
          parse: function (e, n) {
            return (
              "string" == typeof e && "string" == typeof n ? (e = t(e, n)) : e instanceof t || (e = t(e)),
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c
          ...
          : b && x && (p ? (h && m.push(u), c && v.push(d)) : (_i(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
          ...
          h.setWidth(t.minSize.width),
            x
              ...
              : i > 0 &&
                ...
                ((_ = d.x = _ + t.columnWidths[d.line] + n.padding), d.line++, (k = d.y = t.top + b(o, s[d.line])));
          var w = h.x(_);
          !(function (t, e, i) {
            if (!(isNaN(m) || m <= 0)) {
              c.save();
